...
select
    sum(case when t.register_time >= '20150501' and t.register_time <= '20150531' then 1 else 0 end) as cnt_05_m,
    sum(case when t.register_time >= '20150601' and t.register_time <= '20150530' then 1 else 0 end) as cnt_06_m
from (
   select
